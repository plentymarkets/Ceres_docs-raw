...
|         xref:5.0.0@plugin-illuminate::Illuminate/Database/Eloquent/Collection.adoc#[`Collection`]
a|`$statuses`
|A collection of all order status|link:http://php.net/string[`string`^]
a|`$lang`
|The currently selected shop language|link:http://php.net/string[`string`^]
a|`$template`
...
public getItemsPerPage($widgetSettings):void
